...
![Get Rebates Step 1](/snapShots/getFeesClaimable.jpg "Get Rebates Step 1")

1. Go to the `rebatePerWallet` function, input your rebate wallet address, then click on the "Query" button.

![Get Rebates Step 2](/snapShots/getRebates-1.jpg "Get Rebates Step 2")
...
![Get Rebates Step 3](/snapShots/getRebates-2.jpg "Get Rebates Step 3")
...
![Claim Rebates Step 1](/snapShots/claimFees-1.jpg "Claim Rebates Step 1")

2. Click on the "Connect to Web3" button.

![Claim Rebates Step 2](/snapShots/claimFees-2.jpg "Claim Rebates Step 2")
...
![Claim Rebates Step 3](/snapShots/claimReserveRebate.jpg "Claim Rebates Step 3")
